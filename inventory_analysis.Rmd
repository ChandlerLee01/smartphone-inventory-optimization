...
charToRaw(svg) |> rsvg::rsvg_png("data/flowchart_labeled.png")
knitr::include_graphics("data/flowchart_labeled.png")
```
...
charToRaw(svg) |> rsvg_png("data/Value_Stream_Map_No_Time.png")
knitr::include_graphics("data/Value_Stream_Map_No_Time.png")
```
